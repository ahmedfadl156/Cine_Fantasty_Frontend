...
import { BuyMovieModal } from "./BuyMovieModal";
    ...
    return (
        <>
                    ...
                    <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-end gap-10 md:gap-16">
                        ...
                        <div className="flex-1 flex flex-col gap-6">
                            ...
                            <button
                                ...
                                className="w-fit flex items-center gap-2.5 bg-primary text-on-surface px-8 py-4 text-sm font-ui font-medium uppercase tracking-widest hover:bg-primary/80 cinematic-transition shadow-[0_0_30px_rgba(200,53,42,0.35)]"
                            >
            ...
            <BuyMovieModal
                ...
                movie={{
                    systemId: draftInfo.systemId,
                    title: draftInfo.title,
                    posterPath: draftInfo.posterPath,
                    purchasePriceInDollars: draftInfo.purchasePriceInDollars,
                    gameStatus: draftInfo.gameStatus,
                }}
            />
        </>
    );
